...
socket.on('vote', function(vdata){
	...
	var optionValue = document.querySelector('tr#choice_'+vdata.selection+' .result');
	...
	for (var i = 0; i < numOptions; i++) {
		total += parseInt(document.querySelector('tr#choice_'+i+' .result').innerHTML);
	}

	for (var i = 0; i < numOptions; i++) {
		var rowValue = parseInt(document.querySelector('tr#choice_'+i+' .result').innerHTML);
